...
function RoomBooked() {
  ...
  const handleBooking =  async() =>{
    ...
    if(!name || !email || !phone || !country ){
      alert('Please fill all the fields')
           ...
           const savedRoom =  await axios.post('https://relaxhotel.herokuapp.com/booking', {
          name,
          email,
          roomTitle,
          phone,
 ...
 const generateInvoice = () =>{
  axios.post('https://relaxhotel.herokuapp.com/create-room-pdf', {
      name,  roomTitle, email, phone,  country,  totalPrice,  identificationcard,  days, invoiceNo
    }).then(() => axios.get('https://relaxhotel.herokuapp.com/room-invoice', {responseType:'bolb'})).then((res) => {
